...
public class MasterOperationalController {
	...
	@DeleteMapping("/public-holidays/{id}") public ResponseEntity<Void> deletePublicHoliday(@PathVariable Long id) { service.deletePublicHoliday(id); return ResponseEntity.noContent().build(); }
